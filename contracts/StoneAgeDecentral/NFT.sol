...
contract StoneAgeDecentralNFT is ERC721URIStorage {
    ...
    constructor() ERC721("StoneAgeDecentralNFT", "SAD_NFT"){
    ...
    function executeSale(uint256 tokenId) public payable{
        ...
        require(listing.owner != address(0), "NFT not listed for sale");
